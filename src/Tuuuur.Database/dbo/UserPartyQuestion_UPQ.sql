...
(
    ...
    [Id_Guest]          UNIQUEIDENTIFIER    NULL,
    [GuestNickname]     NVARCHAR(50)        NULL,
...
CREATE NONCLUSTERED INDEX [IX_UserPartyQuestion_Guest]
    ON [dbo].[UserPartyQuestion_UPQ]([Id_Guest], [Id_Party_Question]);
GO
