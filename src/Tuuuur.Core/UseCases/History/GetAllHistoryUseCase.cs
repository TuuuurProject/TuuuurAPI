...
internal class GetAllHistoryUseCase(
    ...
    : ADbUseCase<GetAllHistoryRequest, GenericEntityResponse<HistoryPage>>(p_Logger,  p_UnitOfWork)
{
    protected override async Task<GenericEntityResponse<HistoryPage>> HandleLogic(GetAllHistoryRequest p_Request, CancellationToken p_CancellationToken)
    {
