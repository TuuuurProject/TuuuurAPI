...
public interface ICacheService
{
    ...
    Task HashSetAsync<T>(string p_MasterKey, string p_FieldKey, T p_Value, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
    ...
    Task<long> ListRightPushAsync<T>(string p_Key, T p_Value, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
    ...
    Task<bool> SetAddAsync<T>(string p_Key, T p_Value, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
    Task<long> SetAddRangeAsync<T>(string p_Key, IEnumerable<T> p_Values, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
    ...
    Task<bool> SortedSetAddAsync<T>(string p_Key, T p_Value, int p_Score, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
    ...
    Task<string> StreamAddAsync<T>(string p_Key, T p_Value, TimeSpan p_Expiration = default, CancellationToken p_CancellationToken = default);
