...
public class CreateSoloPartyUseCaseTests
{
    ...
    public async Task Handle_ExpectedAsync()
    {
        ...
        Mock<IMappingAddEntity<PartyBase, IEntity>> v_MappingAddEntityMock = new();
        ...
        m_UnitOfWorkMock.Setup(p_U => p_U.PartyRepository.CreatePartyAsync
            (It.IsAny<PartyBase>(), It.IsAny<CancellationToken>())).ReturnsAsync(v_MappingAddEntityMock.Object);
