...
public class GenerateOptUseCaseTests
{
    ...
    public GenerateOptUseCaseTests()
    {
        ...
        Mock<ILogger<GenerateOptUseCase>> v_LoggerMock = new();

        m_UseCase = new GenerateOptUseCase(m_UnitOfWorkMock.Object, v_LoggerMock.Object);
    }
    ...
    {
        // Arrange
        User v_User = new() { Id = Guid.NewGuid() };
